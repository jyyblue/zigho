                  ...
                  <div class="widget-content">
                    ...
                    <table class="table table-bordered footable">
                      ...
                      <tbody>
                            ...
                            <tr>
                            	<td><?php _l('Generate script archive');echo ' RE GEOPORTAL '.$settings['template']; ?></td>
                                <td><a href="<?php echo site_url('admin/benchmarktool/generate_script_regeo/'.$settings['template'])?>" class="btn btn-info btn-sm"><?php _l('Run tool'); ?></a></td>
                                </tr>
                                <tr>
