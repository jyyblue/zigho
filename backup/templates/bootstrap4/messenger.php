                                ...
                                <table class="table table-messages" id="dialogs">
                                    ...
                                    <?php if(sw_count($all_dialogs)): foreach($all_dialogs as $key => $dialog):?>
                                        <tr data-sel_id="<?php _che($dialog['interlocutor_id']);?>" data-property_id="<?php echo $dialog['property_id'];?>" class="<?php echo !empty($dialog['unreaded']) ? 'is_unreaded': ''; ?>">
                                            ...
                                            <td class="hidden-md-down contact">
                                            ...
                                            <td class='cntl'><?php echo anchor('fmessages/messenger/?del_dialog='.$dialog['interlocutor_id'].'&property_id='.$dialog['property_id'], '<i class="fa fa-remove"></i><span class="hidden-md-down"> '.lang('Delete').'<span>', array('onclick' => 'return confirm(\''.lang_check('Are you sure?').'\');return false;', 'class'=>'btn btn-middle btn-danger'))?></td>
                                        </tr>
                                    <?php endforeach;?>
                                    <?php else:?>
                                        <tr>
