                    ...
                    <div class="widget widget-box box-container">
                        ...
                        <div class="widget-content widget-controls"> 
                            ...
                            <?php if(file_exists(APPPATH.'controllers/admin/booking.php')):?>
                                ...
                                <?php echo anchor('rates/index/'.$lang_code.'#content', '<i class="fa fa-calendar"></i>&nbsp;&nbsp;'.lang_check('Edit availability and rates'), 'class="btn btn-link btn-middle pull-right" style="margin-right:5px;"')?>
                            <?php endif; ?>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <?php if($estate->is_activated == 0 && $settings_activation_price > 0  && config_db_item('payments_enabled') == 1):?>
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li><a href="<?php echo site_url('paymentconsole/strip_payment/'.$lang_code.'/'.$settings_featured_price.'/'.$settings_default_currency.'/'.$estate->id.'/ACT'); ?>"><?php echo '<i class="fa fa-shopping-cart"></i> '.lang('Pay for featured').' '.lang_check('via stripe.com'); ?></a></li>
                                                <?php endif; ?>
                                            </ul>
                                            </div>
                                        <?php endif;?>
