...
<a class="btn btn-info popup-with-form-report" style="display:inline-block;margin-left: 5px;" id="report_property" href="#popup_report_property"><i class="icon-flag icon-white" style="margin-top: 3px;"></i> <?php echo lang_check('Report property'); ?> <i class="load-indicator"></i></a>
    <?php endif; ?>    
    ...
    <div id="main">
        ...
        <div class="control-group">
            <div class="controls">
                <div class="checkbox">
                    <label>
                        <input name="allow_contact" class="" value="1" type="checkbox" style="margin-top: 5px;"> <?php echo lang_check('I allow agent and affilities to contact me'); ?>
                    </label>
                </div>
            </div>
        </div>
        ...
        <div class="control-group">
            <div class="controls">
                ...
                <img id="ajax-indicator-masking" src="assets/img/ajax-loader.gif" style="display: none;" alt="indicator"/>
            </div>
        </div>
    </div>
</form>
