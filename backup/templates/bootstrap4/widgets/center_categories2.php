<?php
/*
Widget-title: Categories 2
Widget-preview-image: /assets/img/widgets_preview/center_categories2.jpg
*/
?>
...
<?php else: ?>
    ...
    <div class="properties treefield-categories-2">
        <!-- PROPERTY LISTING -->
                        ...
                        <div class="treefield-categories clearfix">
                            <?php if (sw_count($item['childs_8']) > 0) foreach ($item['childs_8'] as $child): ?>
                                <?php if(!empty($child['url'])): ?>
                                    <a href="<?php _che($child['url']); ?>"class="treefield-box-item btn-default"><?php _che($child['title']); ?> (<?php _che($child['count']);?>)</a>
                                <?php else:?>
                                    <a href='<?php echo site_url_nosuff($lang_code.'/'.$this->data['page_id'].'/?search={"v_search_option_'.$treefield_id.'":"'.rawurlencode($item['title_chlimit'].' - '.$child['title'].' - ').'"}'); ?>' class="treefield-box-item btn-default"><?php _che($child['title']); ?>  (<?php _che($child['count']);?>)</a>
                                <?php endif;?>
                            <?php endforeach; ?>
                        </div>
                    </div>
