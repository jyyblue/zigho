...
{
    echo '<div class="widget widget-box box-container">';
    
    echo '<div class="widget-header text-uppercase">';
    echo '<h2 class="title">'.$options_name_65.'</h2>';
    echo '</div>';
    
    $rep_value.= '<ul data-target="#modal-gallery" data-toggle="modal-gallery" class="images-gallery clearfix row"> ';
