    ...
    <div class="container">
        ...
        <form action="{page_current_url}#main-search" class="form-horisontal">
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="form-group">
                        <input type="text" class="form-control color-secondary" placeholder="{lang_CityorCounty}" name="search_option_smart" value="{search_query}"  id="search_option_smart">
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="form-group">
                ...
                <div class="col-lg-3">
                    <div class="form-group">
                        <select class="form-control selectpicker color-secondary" name="search_option_3" id="search_option_3">
                            {options_values_3}
                        </select>
                    </div>
                </div>
