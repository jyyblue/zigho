...
$(document).ready(function(){
    ...
    if(!$('#TREE-GENERATOR_ID_<?php echo $treefield_id;?>').length) {
        $('.search-form .form-horisontal').append('<input type="text" class="hidden form-control search_option_<?php echo $treefield_id;?>" name="search_option_<?php echo $treefield_id;?>" value="" id="search_option_<?php echo $treefield_id;?>">')
    }
