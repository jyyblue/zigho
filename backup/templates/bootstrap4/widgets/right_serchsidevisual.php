...
Widget-title: Right Search Visual
...
<section class="search-form color-primary" id="search-right">
<div class="">
    <h2 class="search-title"><?php echo _l('Search');?></h2>
<form action="{page_current_url}#search-right" class="form-horisontal form-primary">
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <button type="submit"  id="search-start" class="btn btn-search color-secondary"><i class="fa fa-search fa-color-white hide_on_ajax"></i><i class="fa fa-spinner fa-spin ajax_v fa-ajax-indicator hidden"></i></button>
        </div>
    </div>
