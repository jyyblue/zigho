...
<section class="header-slider">
    <h3 class="hidden-xs-up"><?php echo _l('Slider big');?></h3>
    <!-- Carousel container -->
    <div id="header-slider" class="carousel slide slider-tall slider-full-height" data-ride="carousel">
        <!-- Indicators -->
        ...
        <div class="carousel-inner" role="listbox">
            ...
            <?php foreach($slideshow_images as $key=>$file): ?>
                <div class="carousel-item <?php _che($file['first_active']);?>">
                    <img src="<?php echo $file['url']; ?>" alt="<?php _che($file['alt']);?>">
