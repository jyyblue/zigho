...
<?php
    ...
    $drop_selected = array();
    echo '<div class="row tree TREE-GENERATOR" id="TREE-GENERATOR_ID_'.$f_id.'">';
    echo '<div class="field-tree col-sm-3">';
    echo form_dropdown('option'.$field_id.'_'.$lang_id.'_level_0', $drop_options, $drop_selected, 'class="form-control selectpicker base no-padding tree-input color-secondary" id="sinputOption_'.$lang_id.'_'.$field_id.'_level_0'.'"');
    echo '</div>';
    ...
    for($ti=1;$ti<=$levels_num;$ti++)
    {
        ...
        echo '<div class="field-tree col-sm-3" >';
        echo form_dropdown('option'.$field_id.'_'.$lang_id.'_level_'.$ti, array(''=>$lang_empty), array(), 'class="form-control selectpicker base no-padding tree-input color-secondary" id="sinputOption_'.$lang_id.'_'.$field_id.'_level_'.$ti.'"');
        echo '</div>';
    }
    echo '</div>';
