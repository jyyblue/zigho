...
<script>
    ...
    $(function() {
        $(".form-additional .TREE-GENERATOR#TREE-GENERATOR_ID_<?php echo $f_id;?> select").change(function(e, trigger){
        ...
        if(select_element.length > 0 && s_value != '')
        {
            ...
            $.getJSON( "<?php echo site_url('api/get_level_values_select'); ?>/"+s_lang_id+"/"+s_field_id+"/"+s_value+"/"+parseInt(s_level+1), function( data ) {
                ...
                if(first_load === true){
                    ...
                    $(".form-additional .TREE-GENERATOR#TREE-GENERATOR_ID_<?php echo $f_id;?>").find('select:first').trigger('change', [trigger]);
                }
...
<?php
    ...
    $drop_selected = array();
    echo '<div class="tree TREE-GENERATOR secondary" id="TREE-GENERATOR_ID_'.$f_id.'">';
