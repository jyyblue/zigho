...
<div class="form-group <?php echo $class_add; ?>" style="<?php _che($field->style); ?>">
    <input type="text" data-option_id="<?php echo $f_id; ?>" class="form-control input_am<?php echo $direction;?> id_<?php echo $f_id; ?>" placeholder="<?php echo $placeholder ?><?php echo $suf_pre; ?>">
</div><!-- /.form-group -->