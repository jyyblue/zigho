...
<div class=" <?php echo $class_add; ?>" style="<?php _che($field->style); ?>">
    <div class="form-group form-group-lg field_select">
        <select id="search_option_<?php echo $f_id; ?><?php echo $direction;?>" name="search_option_<?php echo $f_id; ?><?php echo $direction;?>" class="form-control select_styled base no-padding color-secondary">
