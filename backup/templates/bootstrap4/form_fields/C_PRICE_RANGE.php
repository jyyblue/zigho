...
<div class="<?php echo _ch($class_add); ?>">
    <div class="form-group">
        <div class="scale-range sw_scale_range" id="nonlinear-price">
            <div class="hidden config-range"
              ...
              data-infinity="false"
              data-predifinedMin="<?php echo _ch(search_value('36_from'), ''); ?>"
              data-predifinedMax="<?php echo _ch(search_value('36_to'), ''); ?>"
            >
            </div>
            ...
            <input id="search_option_36_from" name="search_option_36_from" type="text" class="value-min hidden" value="<?php echo _ch(search_value('36_from')); ?>" />
            <input id="search_option_36_to" name="search_option_36_to" type="text" class="value-max hidden" value="<?php echo _ch(search_value('36_to')); ?>" />
        </div>
    </div>
</div>