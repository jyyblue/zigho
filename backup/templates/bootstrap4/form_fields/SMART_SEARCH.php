    ...
    <div class="row clearfix">
        <div class="col-xl-12">
            <div class="form-group form-group-lg field_select">
                <input id="search_option_smart" name="search_option_smart" type="text" class="form-control noavtoWidth color-secondary"   value="{search_query}" placeholder="{lang_CityorCounty}" autocomplete="off" />
            </div>
        </div>
        <!--
        <div class="col-xl-4">
