...
<main class="detailproject">
    ...
    <div class="container-fluid bgmenupro">
        <div class="container-fluid w90 padtop30 row m-auto" style="padding: 15px 0;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 lineheight220">
                            ...
                            <div><span>{{ __('Number of blocks') }}:&nbsp;</span>
                                <b>{{ number_format($project->number_block) }}</b>
                            </div>
                            @endif
                            @if ($project->number_floor)
                            <div><span>{{ __('Number of floors') }}:&nbsp;</span>
                                <b>{{ number_format($project->number_floor) }}</b>
                            </div>
                            @endif
                            @if ($project->number_flat)
                            <div><span>{{ __('Number of flats') }}:&nbsp;</span>
                                <b>{{ number_format($project->number_flat) }}</b>
                            </div>
                            @endif
                        </div>
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <p><i><img src="{{ RvMedia::getImageUrl($facility->getMetaData('icon_image', true)) }}" alt="{{ $facility->name }}" style="vertical-align: top; margin-top: 3px;" width="18" height="18"></i> {{ $facility->name }} - {{ $facility->pivot->distance }}
                                    </p>
                                    @else
