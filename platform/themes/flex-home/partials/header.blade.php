            ...
            <div class="row">
                <div class="col-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        ...
                        <div>
                            @if (is_plugin_active('real-estate') && RealEstateHelper::isLoginEnabled())
                                <a class="btn btn-primary add-property d-none-min-992" href="{{ route('public.account.properties.index') }}">
                        ...
                        <div class="collapse navbar-collapse justify-content-end animation" id="navbarSupportedContent">
                            ...
                            <div class="main-menu-content">
                                ...
                                <div class="main-menu-nav d-lg-flex">
                                    ...
                                    !!}
                                    @if (is_plugin_active('real-estate') && RealEstateHelper::isLoginEnabled())
                                        <a class="btn btn-primary add-property d-none-max-992" href="{{ route('public.account.properties.index') }}">
                                            <i class="fas fa-plus-circle"></i> {{ __('Post Property') }}
                                        </a>
                                    @endif
